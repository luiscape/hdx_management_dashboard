...
base_url = 'https://us2.api.mailchimp.com/2.0/'
method_url = 'lists/activity?'
api_url = paste('apikey=', api_key, sep = "")
limit_url = paste('&limit=', 300, sep = "")
...
hdx_list <- data[data$from_email == 'hdx@un.org', ]
